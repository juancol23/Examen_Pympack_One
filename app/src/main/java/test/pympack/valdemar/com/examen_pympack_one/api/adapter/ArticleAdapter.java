package test.pympack.valdemar.com.examen_pympack_one.api.adapter;
...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.design_item,parent,false);
